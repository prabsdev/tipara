...
<br><font size="5"><font color="white" face="courier new">Selama ini mungkin kamu suka aku aku slalu mengintaimu jadi gini ini kubuat buat nembak kamu kamu mau gak jadi pacar aku</font>
...
<br><a href="https://api.whatsapp.com/send?phone=6282133078268&text=Ya%20aku%20Mau%20Terima"><input type="button" value="iya aku mau" onclick="alert('Thanks yah udah mau trima aku apa ada nya');" style="font size="5"></a><><><><a href="https://api.whatsapp.com/send?phone=6282133078268&text=maaf%20aku%20nggabisa%20Terima"><input type="button" value=" Maaf aku gabisa" onclick="alert('Baik lah kalau itu mau mu ^_^');" style="font size="5"></a>
<br><br><br><hr color="red">

<br><br><br><a href="http:/tiktok.com/@bapak_coding"><input type="button" value="Contact me on Tiktok" onclick="alert('Loading, click ok');""></a>
</body>
<style type="text/css">
